...
sealed class SyncTriggerStatement : AbstractSqlStatement() {
    ...
    data class AddSyncTriggerStatement(
        override val tableName: String?,
        override val leftColumn: String?,
        override val rightColumn: String?
    ) : SyncTriggerStatement()
    data class DropSyncTriggerStatement(
        override val tableName: String?,
        override val leftColumn: String?,
        override val rightColumn: String?
    ) : SyncTriggerStatement()
